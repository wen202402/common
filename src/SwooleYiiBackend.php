...
class SwooleYiiBackend extends BaseObject{
    ...
    public function init(){
        ...
        $this->options['pid_file']=  ($docroot = $this->docmentRoot . DIRECTORY_SEPARATOR) . 'backend/runtime/swoole.pid';
    ...
    public function onRequest(\Swoole\Http\Request $request, \Swoole\Http\Response $response){
        ...
        $_SERVER['SCRIPT_FILENAME'] = Yii::getAlias('@webroot'.$scriptName, false) ?: ($this->docmentRoot . $scriptName);
